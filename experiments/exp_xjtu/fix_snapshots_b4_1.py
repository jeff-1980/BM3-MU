...
import sys, pathlib
sys.path.insert(0, str(pathlib.Path(__file__).parents[2]))  # <repo_root>
...
SNAP_DIRS = [
    pathlib.Path(__file__).resolve().parents[2] / "results" / "exp_xjtu_lobo_kin",
    pathlib.Path(__file__).resolve().parents[2] / "results" / "exp_xjtu_cross_kin",
]
