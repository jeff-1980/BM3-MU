...
run_if_needed \
    ...
    results/exp_xjtu_lobo_nokin

run_if_needed \
    experiments/exp_xjtu/config_lobo_kin.yaml \
    results/exp_xjtu_lobo_kin
...
run_if_needed \
    ...
    results/exp_xjtu_lobo_dual_nokin

run_if_needed \
    experiments/exp_xjtu/config_lobo_dual_kin.yaml \
    results/exp_xjtu_lobo_dual_kin
...
run_if_needed \
    ...
    results/exp_xjtu_cross_nokin

run_if_needed \
    experiments/exp_xjtu/config_cross_kin.yaml \
    results/exp_xjtu_cross_kin
...
run_if_needed \
    ...
    results/exp_xjtu_cross_dual_nokin

run_if_needed \
    experiments/exp_xjtu/config_cross_dual_kin.yaml \
    results/exp_xjtu_cross_dual_kin
